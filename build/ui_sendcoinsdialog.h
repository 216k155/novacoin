...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 BHC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 BHC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 BHC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 BHC"));
        ...
        labelBalance->setText(QStringLiteral("123.456 BHC"));
